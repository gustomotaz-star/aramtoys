...
React + Vite storefront and management app for Aram Toys.
...
- `src/styles/storefront.css` — shared storefront components.
- `src/styles/admin.css` — management/dashboard styling.
- `src/config/app.js` — business/UI constants such as shipping, currency, low-stock threshold and order statuses.
- `src/lib/supabase.js` — one Supabase client for the application.
